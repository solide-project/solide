...
export function SolideIDE({
  ...
  return (
    <div className="max-h-screen">
      ...
      <div className="flex">
        <div className={cn("p-4 rounded max-h-screen overflow-y-scroll overflow-x-hidden", `${isFileSytemVisible ? '' : 'hidden'}`)}>
          <FileTree />
        </div>
        ...
        <ResizablePanelGroup
          direction="horizontal" className=""
        >
          <ResizablePanel defaultSize={70} className={cn("relative", `${isEditorVisible ? '' : 'hidden'}`)}>
