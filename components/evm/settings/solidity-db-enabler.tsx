...
export function SolidityDBEnabler({}: SolidityDBEnablerProps) {
  const evm = useEVM()
  return (
    <div className="flex items-center space-x-2 rounded-md bg-grayscale-100 px-4 py-1 lg:p-4">
      <Checkbox
        id="optimizer"
      ...
      >
        Store contract with Solidity DB. (This will make your contract more
