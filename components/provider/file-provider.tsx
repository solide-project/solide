...
export const SolideFileProvider = ({ children }: SolideFileProviderProps) => {
  ...
  const [selectedSolcVersion, setSelectedSolcVersion] =
    useState<string>(solcVersion)
...
interface SolideFileProviderProps extends React.HTMLAttributes<HTMLDivElement> {
  name?: string
}
